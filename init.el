...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (golden-ratio youdao-dictionary yasnippet yaml-mode wttrin ws-butler web-mode use-package undo-tree smartparens slime slim-mode skewer-mode scss-mode rvm ruby-refactor robe region-bindings-mode rainbow-delimiters projectile-rails pinyin-search phi-search multiple-cursors micgoline markdown-mode magit indium indent-guide helm-themes helm-projectile helm-descbinds haml-mode gruvbox-theme github-stars geiser expand-region exec-path-from-shell emr diff-hl coffee-mode circadian chicken-scheme cal-china-x browse-at-remote bing-dict auto-package-update aggressive-indent ace-window))))
(custom-set-faces
